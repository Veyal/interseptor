# Changelog archive (pre-0.12.0)

Older release notes moved from CHANGELOG.md to keep the main file scannable.

See [CHANGELOG.md](../CHANGELOG.md) for 0.12.0 and later.
