---
layout: default
title: Custom active checks
classification: current
source: docs/custom-active-checks.md
---
<p class="eyebrow">CURRENT</p>
# Writing custom ACTIVE checks

> The passive twin of this guide is [`docs/custom-checks.md`]({{ "/custom-checks/" | relative_url }}) — read that first if
...
More ready-to-copy examples ship in [`examples/active-checks/`](https://github.com/Veyal/interseptor/tree/main/examples/active-checks/).
