...
*who* published the pack — see [PRD-0003](https://github.com/Veyal/interseptor/blob/main/docs/product/prd-0003-rule-packs.md).
...
[custom checks]({{ "/custom-checks/" | relative_url }}) / [active checks]({{ "/custom-active-checks/" | relative_url }})),
