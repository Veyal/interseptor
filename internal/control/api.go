...
var apiRoutes = []apiRoute{
	...
	{"PUT", "/api/settings", "Update settings (rebinds proxy/control listeners). Body: any subset of {proxyAddr, proxyAddrs, controlAddr, upstreamProxy, aiProvider, aiApiKey, aiModel, aiEndpoint, aiDisabled, oobEnabled, captureScopeOnly, suppressBrowserTelemetry, suppressAndroidTelemetry, invisibleProxy, tlsBypassHosts, autoBypassOnPinFailure} — only fields present are changed"},
