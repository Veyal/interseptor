...
var apiRoutes = []apiRoute{
	...
	{"PUT", "/api/settings", "Update settings (rebinds proxy/control listeners). Body: any subset of {proxyAddr, proxyAddrs, controlAddr, upstreamProxy, upstreamProxyCA, oobEnabled, captureScopeOnly, suppressBrowserTelemetry, suppressAndroidTelemetry, invisibleProxy, tlsBypassHosts, originTLSVerifyBypassHosts, autoBypassOnPinFailure} — only fields present are changed"},
