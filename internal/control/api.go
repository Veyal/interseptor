...
var apiRoutes = []apiRoute{
	...
	{"GET", "/api/findings/{id}", "Get one finding with body blocks, PoC flows, and ready/missing completeness"},
	{"PATCH", "/api/findings/{id}", "Update a finding (only fields sent are changed). Body: any subset of {severity, status, title, target, impact, why, cwe, environment, fix, cvss, verificationInstructions, body, detail, evidence}"},
